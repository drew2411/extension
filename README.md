...
Block custom content on any site using AI intent detection. A privacy-first, powerful extension that helps you stay focused by blocking distractions while allowing productive content, driven entirely by your own defined "Intents".
...
* **Bring Your Own Key (BYOK):** The extension uses the Groq API for lightning-fast AI processing. You provide your own key, ensuring maximum privacy and zero recurring subscription costs for the core AI logic.
...
### ⚖️ Conflict Resolution & Productive Dominance
...
### ⚙️ Advanced Keyword Transparency
...
*Take back control of your attention with the power of intent-driven AI.*
